      ...
      registerForm.addEventListener('submit', async (event) => {
        ...
        try {
          ...
          if (registrado !== null) {
            ...
            console.log('No se encontró ningún usuario con este email, continuando con el registro...');
            // Continuar con el proceso de registro
            // No se muestra un mensaje de error ya que no se encontró ningún usuario durante la búsqueda
          }
        } catch (error) {
          console.error('Ha ocurrido un error al registrar el usuario:', error);
          alert(error.message);
